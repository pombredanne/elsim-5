...
If the above signature is compiled, the result might look like this:

    {
        'Name of the Signature': [
            [
                [0, 'QltGMVOtherBase64...', 2.879434986262386, 4.543216940597991, 4.117698018239283, 1.9877090089569163],
                [1, 'QltGMVMoreBase64...', 1.0, 4.422101412015318, 3.889157713499765, 0.0]
            ],
            'a && b'
        ]
    }
